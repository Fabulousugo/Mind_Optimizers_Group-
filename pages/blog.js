    ...
    <div className="overflow-hidden">
      <div className="bg-[#0a1d2e]">
        ...
        <div className="text md:p-auto mx-auto max-w-5xl p-7 text-left text-[#c8cacd] md:text-center">
          ...
          Find out how to maximize the use of your NFTs. Discover the most recent NFTs news, advice,
          and tactics right here on BSC from your chatty,
           amiable NFT marketplace.
          </p>
