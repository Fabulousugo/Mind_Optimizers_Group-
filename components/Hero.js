        ...
        <div className={style.contentWrapper}>
          <div className={style.copyContainer}>
            ...
            <div className={style.description}>
              OptiMint is the world&apos;s largest and most reliable NFT
              marketplace
            </div>
          ...
          <div className={style.cardContainer}>
            <img
              ...
              src="https://gateway.pinata.cloud/ipfs/QmfPByAAmPAbobUHt9TmFF4nASXmqDU2vy3hysZPfW7Lw2"
              alt="image"
            />
            ...
            <div className={style.infoContainer}>
              <img
                ...
                src="https://gateway.pinata.cloud/ipfs/QmTNxuvXeMi7KYaWX3crN8JP33eyAxuKarrQyCbZPutc2K?_gl=1*1bl6w6v*_ga*MTc2NjA3MjIzNy4xNjczOTQxMTE4*_ga_5RMPXG14TE*MTY3NDM5NzU4My43LjEuMTY3NDM5ODIxOC40Ny4wLjA."
                alt="profile picture"
              />

              <div className={style.author}>
                <div className={style.name}>Mind optimizers Group#108</div>
